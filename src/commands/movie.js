...
async function execute(interaction) {
  ...
  try {
    ...
    // Step 4: Search Prowlarr with canonical title + year
    ...
    // Step 5: Claude relevance filter
    const t5 = Date.now();
